...
public class Buscaminas {
    ...
    static final int[] valoresI = {-1, -1, -1, 0, 1, 1, 1, 0}; //modificadores de fila ordenados - se relaciona con coordenada "y"
    static final int[] valoresJ = {-1, 0, 1, 1, 1, -1, 0, -1}; //modificadores de columna ordenados - se relaciona con coordenada "x"
    ...
    static void partida(){
        ...
        do {
            ...
            if(accion.equals(accionesPermitidas[2]) || accion.equals(accionesPermitidas[3])){ //si la jugada es marcar, realizamos el marcaje o desmarcaje
                ...
                if(jugador[y][x].equals("!")){ //no se mete en el switch porque evalúa la otra matriz
